...
//eslint-disable-next-line iport/extensions
...
class AllJobs extends Component {
  ...
  onGetProfileDetails = async () => {
    ...
    if (responseProfile.ok === true) {
      ...
      const updatedDataProfile = fetchedDataProfile.map(eachItem => ({
        ...
        profileImgUrl: eachItem.profile_details.profile_img_url,
  ...
  onGetJobsFailureView = () => (
    <div className="failure-img-button-container">
      <img className="failure-img" src={failureViewImg} alt="failure img" />
