...
class Jobs extends Component {
  ...
  getJobs = async () => {
    ...
    const apiUrl = `https://apis.ccbp.in/jobs?employment_type=${employeeType.join()}&minimum_salary=${minimumSalary}&search=${searchInput}`
  ...
  renderFailureView = () => (
    <div className="jobs-error-view-conatiner">
      <img
        src="https://assets.ccbp.in/frontend/react-js/failure-img.png"
        alt="failure view"
        className="jobs0failure-img"
      />
      <h1 className="jobs-failure-heading-text">Oops1 Something Went Wrong</h1>
      <p className="jod-failure-description">
        ...
        <div className="jobs-container">
          <div className="jobs-content">
            ...
            <div className="search-input-jobs-list-container">
              <div className="search-input-conatiner-desktop">
                <input
                  type="search"
